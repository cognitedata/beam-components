        ...
        mainInput.apply("Write output to BQ", BigQueryIO.<Asset>write()
                ...
                .withFormatFunction((Asset element) -> {
                    ...
                    return new TableRow()
                            ...
                            .set("parent_id", element.hasParentId() ? element.getParentId() : null)
                            .set("parent_external_id", element.hasParentExternalId() ? element.getParentExternalId() : null)
                            .set("description", element.hasDescription() ? element.getDescription() : null)
                            .set("root_id", element.hasRootId() ? element.getRootId() : null)
                            ...
                            .set("child_count", element.hasAggregates() && element.getAggregates().hasChildCount() ?
                                    element.getAggregates().getChildCount() : null)
                            .set("depth", element.hasAggregates() && element.getAggregates().hasDepth() ?
                                    element.getAggregates().getDepth() : null)
                            .set("path", path)
